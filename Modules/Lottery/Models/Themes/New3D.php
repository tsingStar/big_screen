...
class New3D implements ThemeInterface{

    var $_data=['prizefontcolor' => '#ffd017', 'fontcolor' => '#ffffff', 
        'winnerfontcolor' => '#ffffff', 'layercolor' => 'rgba(0, 0, 0, .9)', 
        'maskcolor' => 'rgba(0, 0, 0, .9)', 'fullscreenmaskcolor' => 'rgba(0, 0, 0, .5)', 
