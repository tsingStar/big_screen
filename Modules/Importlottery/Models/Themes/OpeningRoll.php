...
class OpeningRoll implements ThemeInterface{
    var $_data=[
        'fontcolor' => '#fff', 'prizefontcolor' => '#fff',
        'tabletitlecolor' =>'#ee272d','tabletitlefontcolor'=>'#fff',
        'tablecolor'=>'#fee900','tablefontcolor' => '#000',
